INSERT INTO practice.categories (category_name) VALUES
('Electronics'),
('Books'),
('Home'),
('Clothing');

INSERT INTO practice.customers (first_name, last_name, email, city, signup_date) VALUES
('Shota', 'Sakuma', 'shota1@example.com', 'Tokyo', '2025-01-15'),
...
INSERT INTO practice.products (product_name, category_id, price, stock) VALUES
('Laptop', 1, 120000.00, 10),
('Wireless Mouse', 1, 2500.00, 50),
('SQL for Beginners', 2, 3200.00, 40),
...
INSERT INTO practice.orders (customer_id, order_date, status) VALUES
...
INSERT INTO practice.order_items (order_id, product_id, quantity, unit_price) VALUES
(1, 1, 1, 120000.00),
(1, 2, 2, 2500.00),
(2, 3, 1, 3200.00),
(2, 5, 1, 4800.00),
